...
<tr><td style="padding:22px 38px;background:#f7fbff;border-top:1px solid #e1ebf3;color:#7890a6;font-size:12px;line-height:1.6;">PointerScore · <a href="https://pointerscore.com" style="color:#2f8fe9;text-decoration:none;">pointerscore.com</a><br>Fragen? pointerscore@outlook.com</td></tr>
...
Deno.serve(async (request) => {
  ...
  const response = await fetch(RESEND_API_URL, {
    ...
    body: JSON.stringify({
      from,
      to: [user!.email],
      subject: "Willkommen bei PointerScore",
