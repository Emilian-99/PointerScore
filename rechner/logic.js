...
export function validateInputs(input){
 const errors={};
 if(!String(input.companyName??"").trim())errors.companyName="Bitte gib den Unternehmensnamen ein.";
...
export function calculatePointerScore(input){
 ...
 return{ok:true,total,signal,categories,metrics,analysis,companyName:String(input.companyName).trim()};
}
