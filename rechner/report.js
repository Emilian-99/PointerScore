...
export async function createAnalysisReport(result){
 ...
 if(String(result.notes||"").trim())metrics+='<tr class="personal-note-row"><td>Persönliche Notiz</td><td>'+escapeReportHtml(result.notes)+'</td></tr>';
 const styles=[
  ...
  '.report-table{width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;border:1px solid rgba(130,162,188,.3);border-radius:3mm;background:rgba(255,255,255,.75)}.report-table th,.report-table td{padding:3.3mm 4mm;border-bottom:1px solid #dde7ee;text-align:left;font-size:8.5pt}.report-table th{color:#536b81;background:rgba(235,244,251,.85);font-size:7pt;text-transform:uppercase;letter-spacing:.5pt}.report-table td:last-child{text-align:right;font-weight:800}.report-table tr:last-child td{border-bottom:0}',
  '.personal-note-row td:last-child{text-align:left;font-weight:500;line-height:1.5;white-space:pre-wrap}',
 ...
 const pageOne='<section class="page"><header class="header"><div class="brand">'+logoMarkup+'<div><strong>PointerScore 100</strong><small>Strukturierte Unternehmensanalyse</small></div></div><div class="meta"><b>Analyse erstellt</b>'+escapeReportHtml(createdAt)+'</div></header><div class="title"><p class="kicker">PointerScore Analyse V1.2</p><h1>Unternehmensbewertung</h1><p class="company">'+company+'</p></div><div class="score-panel"><svg class="score-svg" viewBox="0 0 120 120" role="img" aria-label="Gesamtscore '+result.total+' von 100"><circle cx="60" cy="60" r="54" fill="none" stroke="#dfe8ef" stroke-width="9"/><circle cx="60" cy="60" r="54" fill="none" stroke="'+signalColor+'" stroke-width="9" stroke-linecap="round" stroke-dasharray="'+dash+' '+circumference+'" transform="rotate(-90 60 60)"/><text x="60" y="58" text-anchor="middle" font-size="30" font-weight="800" fill="#061b35">'+result.total+'</text><text x="60" y="76" text-anchor="middle" font-size="10" font-weight="700" fill="#718599">VON 100</text></svg><div class="score-summary"><h2>Gesamtscore</h2><span class="signal">'+escapeReportHtml(result.signal.label)+'</span><p>'+escapeReportHtml(result.signal.copy)+'</p></div></div><section class="section"><div class="section-head"><h2>Bewertung nach Kategorien</h2><span>Maximal 100 Punkte</span></div><div class="category-grid">'+categories+'</div></section><section class="section"><div class="section-head"><h2>Automatische Analyse</h2><span>Auf Basis der Eingaben</span></div><div class="analysis"><div class="analysis-card"><h3>Stärken</h3><ul>'+analysisList(result.analysis.strengths,"good")+'</ul></div><div class="analysis-card"><h3>Verbesserungspotenzial</h3><ul>'+analysisList(result.analysis.potential,"warn")+'</ul></div></div></section><footer class="footer"><span>PointerScore 100 - Keine Anlageberatung</span><span>Seite 1 von 2</span></footer></section>';
 const pageTwo='<section class="page"><header class="header"><div class="brand">'+logoMarkup+'<div><strong>PointerScore 100</strong><small>Detailauswertung</small></div></div><div class="meta"><b>'+company+'</b>'+escapeReportHtml(createdAt)+'</div></header><div class="title"><p class="kicker">Berechnete Kennzahlen</p><h1>Detailanalyse</h1><p class="company">Nachvollziehbare Grundlage des Gesamtscores</p></div><table class="report-table"><thead><tr><th>Kennzahl</th><th>Ergebnis</th></tr></thead><tbody>'+metrics+'</tbody></table><section class="section"><div class="section-head"><h2>Gewichtung der Methode V1.2</h2><span>Gesamt 100 Punkte</span></div><div class="method-grid"><div class="method-item"><strong>25</strong><span>Zukunfts-<br>potenzial</span></div><div class="method-item"><strong>25</strong><span>Wachstum</span></div><div class="method-item"><strong>20</strong><span>Finanzielle<br>Stabilität</span></div><div class="method-item"><strong>10</strong><span>Bewertung</span></div><div class="method-item"><strong>20</strong><span>Unternehmens-<br>qualität</span></div></div></section><div class="note"><strong>Hinweis:</strong> PointerScore ist ein vereinfachtes, strukturiertes Bewertungsmodell. Der Bericht dient ausschließlich Bildungs- und Informationszwecken, stellt keine Anlageberatung dar und ersetzt weder eigene Recherche noch eine persönliche Beratung.</div><footer class="footer"><span>PointerScore 100 - Analyse V1.2</span><span>Seite 2 von 2</span></footer></section>';
